...
ModelCheckPoint_filename='G_model.{epoch:02d}-{val_acc:.4f}.h5'
...
cllbks = [
    ...
    ModelCheckpoint(ModelCheckPoint_filename, monitor='val_acc', verbose=1, save_best_only=False, mode='auto', period=1),
    # ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=100, verbose=1)
        ]
model.fit(train_sequences, y, batch_size=128, epochs=3, callbacks=cllbks, validation_split=0.07)
